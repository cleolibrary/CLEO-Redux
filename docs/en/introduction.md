...
Follow the [first steps tutorial](./first-steps.md) to learn how to write and run your first script. Also check our [YouTube playlist](https://www.youtube.com/watch?v=UnVZ81opVo0&list=PLNxQuEFtVkeizoLEQiok7qzr1f0mcwfFb) for video guides.
