...
- Download and install [Ultimate ASI Loader x64](https://github.com/ThirteenAG/Ultimate-ASI-Loader/releases) by ThirteenAG (rename to `version.dll` or any compatible name and copy to the `GTA San Andreas - Definitive Edition\Gameface\Binaries\Win64` directory)
